...
export const ThreadList: FC = (props) => {
  ...
  return (
    <ThreadListPrimitive.Root className="aui-root aui-thread-list-root flex flex-col items-stretch gap-1.5">
      <ThreadListNew revalidator={props.revalidator} optimisticUpdate={props.onUpdateChats}/>
      {/*<ThreadListItems chats={props.chats}/>*/}
      {props.chats.map(chat => <ThreadListItem chat={chat} key={chat.chatId} revalidator={props.revalidator} optimisticUpdate={props.onUpdateChats}/>)}
